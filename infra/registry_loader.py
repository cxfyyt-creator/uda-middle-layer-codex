# =============================================================================
# infra/registry_loader.py
# 注册表加载器 — 统一读取 registries/ 目录下所有 YAML 规则文件
...
# 默认 registries 目录：相对于本文件两级上目录
_DEFAULT_RULES_DIR = Path(__file__).parent.parent / "registries"
...
class RuleLoader:
    ...
    用法：
        ...
        gen_cfg = rl.cmg_gen_config() # registries 中的 generators.cmg 配置
    """
